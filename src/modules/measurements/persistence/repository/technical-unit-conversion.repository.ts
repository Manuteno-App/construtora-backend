...
export class TechnicalUnitConversionRepository extends DefaultTypeOrmRepository<TechnicalUnitConversion> {
  ...
  ): Promise<TechnicalUnitConversion[]> {
  ...
  findApprovedByKeyAndPair(
    ...
    return this.findOne({
      where: {
        ...
        targetUnitId,
        status: In([
          TechnicalUnitConversionStatus.APPROVED,
          TechnicalUnitConversionStatus.PENDING,
        ]),
      },
      relations: { sourceUnit: { family: true }, targetUnit: { family: true } },
    });
  ...
  createEntity(
    data: Partial<TechnicalUnitConversion>,
  ): TechnicalUnitConversion {
  ...
  saveEntity(
    ...
    return this.save(
      data as TechnicalUnitConversion,
    ) as Promise<TechnicalUnitConversion>;
  }
